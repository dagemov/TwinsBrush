    ...
    public partial class initialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Documment = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    ServiceDaysId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DateName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    StartBreak = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndBreak = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PayByHour = table.Column<float>(type: "real", nullable: true),
                    EditRecord = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedRecord = table.Column<DateTime>(type: "datetime2", nullable: true),
                    WeekWorkedId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceService = table.Column<float>(type: "real", nullable: true),
                    Taz = table.Column<float>(type: "real", nullable: true),
                    CustomerDocument = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceStatusType = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Updated = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ServiceId = table.Column<int>(type: "int", nullable: false),
                    EmployedDocument = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CustomerDocuments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalHourService = table.Column<float>(type: "real", nullable: false),
                    TotalToPay = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WeekWorkeds_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonWeeks", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Statements_CountryId_Name",
                table: "Statements",
                columns: new[] { "CountryId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Streets_CityId_Name",
                table: "Streets",
                columns: new[] { "CityId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WeekWorkeds_Id_ServiceId",
                table: "WeekWorkeds",
                columns: new[] { "Id", "ServiceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WeekWorkeds_ServiceId",
                table: "WeekWorkeds",
                column: "ServiceId");
